...
function signInWithToken(token) {
  var apiUrl = 'https://10ax.online.tableau.com/vizportal/api/web/v1/auth/embed/signin';
  var requestData = {
    method: 'POST',
    headers: {
  ...
  fetch(apiUrl, requestData)
    ...
    .then(data => {
      if (data.token) {
        ...
        console.log('Signed in with temporary token. Access token:', accessToken);
