...
function getFreshToken() {
  ...
  xhr.open("GET", "http://mok3bat.pythonanywhere.com/?input=new");
...
var vizClone = document.getElementById("tableauVizClone");

vizClone.addEventListener("firstinteractive", async (event) => {
  // call methods to run immediately after loading
  var sheetClone = vizClone.workbook.activeSheet;
  const saleMap = sheetClone.worksheets.find((ws) => ws.name == "Q3");
  console.log(saleMap);
});
